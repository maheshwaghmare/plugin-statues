...
Extend the plugin from <a href="https://github.com/maheshwaghmare/plugin-statues/">Github</a>.

== Installation ==

1. Install the <code>Plugin Statues - Export and Import</code> plugin either via the WordPress plugin directory, or by uploading the files to your server at <code>wp-content/plugins</code>.
2. Activate plugin.
